...
@Autonomous()
class AutoCloseRed24Qual : AutoBase(Pose(120.0,123.0, 32.0),Colours.RED) {//32 cm from tile intersection
var offset =45.0//TODO tune, this is local doesn t affect other classes
    ...
    override fun onInit(){
        ...
        task = serial(
            ...
            sleepms(400),
            execute{ Joint.setPosition(Joint.COLLECT_POSITION) },
            execute{ goTo(122.7,58.5,25.0)},//collect -6 gate
            preCollectSeq,
            sleepms(2300),//wait at gate
            execute{Shooter.charge()},
            execute{ goTo(82.0,83.0,0.0)},
            ...
            sleepms(650),
            execute { goTo(110.0, 3.5, 0.0) }, // human-8
            preCollectSeq,
            sleepms(1600),
            execute { goTo(140.0, 3.5, 0.0) },//collected
            sleepms(800),
            execute{ goTo(82.0,83.0,0.0)},
            sleepms(200),
            execute{Joint.setPosition(Joint.COLLECT_POSITION+0.2)},
