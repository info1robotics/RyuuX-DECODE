...
@Autonomous
class AutoCloseRed24 : AutoBase(Pose(120.0,123.0, 32.0),Colours.RED) {//32 cm from tile intersection
var offset =45.0//TODO tune, this is local doesn t affect other classes
    ...
    override fun onInit(){
        ...
        task = serial(
            ...
            execute{ goTo(90.0,63.0,0.0)},//pre collect -2  open gate at y 61.2
            preCollectSeq,
            sleepms(900),
            execute{Turret.setPosition(0.319)},
            execute{ goTo(112.3,63.0,0.0)},//collectopen gate at x=118 y=61.2
            sleepms(600),
            afterCollectSeq,
            ...
            sleepms(400),
            execute{ goTo(103.0,60.2,20.0)},//
            sleepms(1200),
            execute{ goTo(122.3,60.2,20.0)},//collect 3
            preCollectSeq,
            sleepms(1200),
            execute{Shooter.charge()},
            ...
            sleepms(400),
            execute{ goTo(103.0,59.8,20.0)},//
            sleepms(1100),//wait for flow
            execute{ goTo(122.3,59.8,20.0)},//collect -4
            preCollectSeq,
            sleepms(1300),//wait at gate
            execute{Shooter.charge()},
            execute{ goTo(82.0,83.0,0.0)},
            sleepms(200),
            //execute{Joint.setPosition(Joint.COLLECT_POSITION+0.2)},
            ...
            execute{ goTo(103.0,58.6,20.0)},//
            sleepms(1200),
            execute{ goTo(123.3,58.6,20.0)},//collect -6
            preCollectSeq,
            ...
            sleepms(400),
            execute{ goTo(103.0,58.3,20.0)},//
            sleepms(1100),
            execute{ goTo(122.3,58.3,20.0)},//collect 7
            preCollectSeq,
            sleepms(1300),
            execute{Shooter.charge()},
            execute{ goTo(82.0,83.0,0.0)},
            ...
            execute{ goTo(103.0,58.3,20.0)},//
            sleepms(1100),//wait for flow
            execute{ goTo(122.3,58.3,20.0)},//collect -8
            preCollectSeq,
            sleepms(1200),//wait at gate
            execute{Shooter.charge()},
            execute{ goTo(82.0,83.0,0.0)},
